...
The same customer app can be built as a PWA for deployment on a normal server:

```bash
npm run build:pwa
```

Deploy this folder to the web server:

```text
customer-miniprogram/dist/build/h5
```

See `PWA_DEPLOYMENT.md` for API proxy and Nginx notes.
