...
const BookingDetailsView = () => import('@/views/customer/BookingDetailsView.vue')
...
const UserRecordsView = () => import('@/views/admin/UserRecordsView.vue')
const BookingRecordsView = () => import('@/views/admin/BookingRecordsView.vue')
...
const routes = [
    ...
    children: [
      ...
      { path: 'register', name: 'register', component: RegisterView },
      {
        ...
        children: [
          ...
          { path: 'history/:bookingId', name: 'booking-details', component: BookingDetailsView },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'users', name: 'user-records', component: UserRecordsView },
      { path: 'bookings', name: 'booking-records', component: BookingRecordsView },
      { path: 'bookings/:bookingId', name: 'admin-booking-details', component: BookingDetailsView },
