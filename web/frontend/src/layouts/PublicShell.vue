  ...
  <div class="public-shell">
      ...
      <nav class="lime-nav">
        ...
        <div class="nav-right">
          <form class="nav-search" @submit.prevent="submitSearch">
            <input v-model="search" class="search-input" placeholder="Search scooters or stations" aria-label="Search scooters" />
    ...
    <main class="public-main">
      <div class="page-shell">
        <div class="page-shell-glow left"></div>
        <div class="page-shell-glow right"></div>
        <RouterView />
      </div>
    </main>
...
.page-shell-glow.left {
  top: -48px;
  left: -70px;
  background: radial-gradient(circle, rgb(91 176 255 / 56%), transparent 68%);
}

.page-shell-glow.right {
  top: 160px;
  right: -70px;
  background: radial-gradient(circle, rgb(53 224 164 / 36%), transparent 68%);
}
</style>
